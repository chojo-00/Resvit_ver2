...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--lambda_vgg', type=float, default=0.0, help='weight for vgg loss')
        self.parser.add_argument('--vgg_layer', type=float, default=0, help='layer of vgg for perc loss')
